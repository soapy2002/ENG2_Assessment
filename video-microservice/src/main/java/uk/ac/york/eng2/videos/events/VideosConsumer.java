...
public class VideosConsumer {
	...
	public void likedVideo(@KafkaKey String title, String eventId, String[] hashtags) {
        System.out.println(eventId + "Video liked:" + title + " hashtags" + Arrays.toString(hashtags));
	}
